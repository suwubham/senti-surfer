  ...
  const handleClick = async () => {
    ...
    if (videoId) {
      ...
      const sentimentResults = [
        ...
        {
          text: "Al final del vídeo me he sentido orgulloso de Albert xD",
          author: "Tommyh",
        ...
        {
          text: "Next step\nAlbert creates Skynet and destroys the entire human race 😮",
        ...
        {
          text: "He’s faster at learning to walk than others",
        ...
        {
          text: "A perfect illustration of how humanity is walking towards a total AI domination! 😂",
        ...
        {
          text: "this is actually so incredible to watch. this is truly amazing and i’m so proud of albert",
          author: "Seán O'Dea",
        ...
        {
          text: "What software you’re using to play with Albert?",
        ...
        {
          text: "I can feel deep emotions in those googly eyes 😭",
        ...
        {
          text: "Stop bullying poor Albert 😠 6:22",
        ...
        {
          text: "Half the people watching had less supportive parents than this AI 😢",
          author: "Mike Tacos",
        ...
        {
          text: "I’d like to think this is how evolution of animals looked when learning to walk over millions of years",
          author: "Trotty -",
        ...
        {
          text: "So when hebstarts over at a task is it an auto restart or do you have to hit restart every time he fails 😆 cause that would suck\n\nI saw the timer 😅",
          author: "Cynnabuns",
        ...
        {
          text: "Aw it’s so cute. Like a baby",
          author: "polydipsiac",
        ...
        {
          text: "I’d love to know just how long these take",
          author: "KuuDefoe",
        ...
        {
          text: "Way to go Albert. 🎉 Even the world gives you lemon you made a lemonade.",
          author: "MK KIM",
